...
jQuery(function($) {
  ...
  $(document).on('click', function(event) {
    if (!$(event.target).closest('#nav-btn-show img, #nav-btn-hide img, #nav-menu').length) {
      $('#nav-menu').hide();
    }
  });
  ...
  var easterEggQuiz = function() {
    ...
    $(parent_selector + " .answer").click(function() {
      ...
      if (num_questions === num_total_highlights) {
        ...
        var social_link_code = '<h4>Share the fun</h4><div id="share-links"><p><a href="http://www.facebook.com/sharer.php?u=http://www.frbsf.org%2Four-district%2Fabout%2Fsf-fed-blog%2Fpresidents-speech-easter-eggs%2F%3Futm_source%3Dfrbsf-home-sffedblog-hero%26utm_medium%3Dfrbsf%26utm_campaign%3Dsffedblog&amp;utm_source=sharebutton&amp;utm_medium=frbsf&amp;utm_campaign=facebook" title="Share on Facebook" target="_blank"><img src="../files/images/icon-facebook.png" width="44" height="44" alt="Share on Facebook"></a><a href="http://twitter.com/share?text=President&apos;s Speech Easter Eggs&amp;url=http://www.frbsf.org%2Four-district%2Fabout%2Fsf-fed-blog%2Fpresidents-speech-easter-eggs%2F%3Futm_source%3Dfrbsf-home-sffedblog-hero%26utm_medium%3Dfrbsf%26utm_campaign%3Dsffedblog&amp;utm_source=sharebutton&amp;utm_medium=frbsf&amp;utm_campaign=twitter" title="Share on Twitter" target="_blank"><img src="../files/images/icon-twitter.png" width="44" height="44" alt="Share on Twitter"></a></p></div>';
